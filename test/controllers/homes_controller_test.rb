...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { kind: @home.kind, name: @home.name, number: @home.number } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { kind: @home.kind, name: @home.name, number: @home.number } }
